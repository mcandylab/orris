...
- [x] **Tank System** — несколько типов танков с уникальными снарядами, характеристиками и балансом
- [x] **XP & Leveling** — начисление опыта за убийства, пороги уровней, событие level-up
- [x] **Tank Evolution System** — дерево эволюций, выбор эволюции при повышении уровня (как в arras.io)
...
| Tank System | 2026-03-13 |
| XP & Leveling | 2026-03-13 |
| Tank Evolution System | 2026-03-13 |
